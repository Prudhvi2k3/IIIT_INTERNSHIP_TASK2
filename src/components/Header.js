  ...
  return (
    ...
    <div className="home-page">
        <div className="div">
            ...
            <img className="odyssey1" alt="Odyssey" src="https://c.animaapp.com/uuBspW1o/img/odyssey.svg" />
            </div>
            <div className="text-wrapper-8"><a className='section' href='#about'>About Us</a></div>
            <div className="text-wrapper-9"><a className='section' href='#community'>Community</a></div>
            <div className="text-wrapper-10"><a className='section' href='#cards'>Education</a></div>
            <div className="text-wrapper-11"><a className='section' href='#'>Stay Connected</a></div>
            <div className="text-wrapper-12"><a className='section' href='#about'>AboutUs</a></div>
            <div className="text-wrapper-13"><a className='section' href='#community'>Community</a></div>
            <div className="text-wrapper-14"><a className='section' href='#cards'>Education</a></div>
